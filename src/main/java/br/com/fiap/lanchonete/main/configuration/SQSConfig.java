...
public class SQSConfig {
    ...
    @Bean
    public String producaoCancelamentoQueue() {
        AmazonSQS sqsClient = amazonSQSAsync();

        CreateQueueResult createQueueResult = sqsClient.createQueue(producaoCancelamentoQueueName);
        return createQueueResult.getQueueUrl();
    }

    @Bean
    public String producaoPedidoPagoQueue() {
        AmazonSQS sqsClient = amazonSQSAsync();

        CreateQueueResult createQueueResult = sqsClient.createQueue(producaoPedidoPagoQueueName);
        return createQueueResult.getQueueUrl();
